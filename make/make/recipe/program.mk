...
ifneq (,$(_MTB_RECIPE__OPENOCD_QSPI_CFG_PATH))
_MTB_RECIPE__OPENOCD_QSPI_CFG_PATH_CMD=-s $(_MTB_RECIPE__OPENOCD_QSPI_CFG_PATH)
endif
...
_MTB_RECIPE__OPENOCD_PROGRAM_ARGS=$(_MTB_RECIPE__OPENOCD_SCRIPTS) $(_MTB_RECIPE__OPENOCD_QSPI_CFG_PATH_CMD) -c "$(_MTB_RECIPE__OPENOCD_QSPI_FLASHLOADER)" -c "set DEBUG_CERTIFICATE $(CY_DBG_CERTIFICATE_PATH)" -c \
...
_MTB_RECIPE__OPENOCD_DEBUG_ARGS=$(_MTB_RECIPE__OPENOCD_SCRIPTS) $(_MTB_RECIPE__OPENOCD_QSPI_CFG_PATH_CMD) -c "$(_MTB_RECIPE__OPENOCD_QSPI_FLASHLOADER)" -c "set DEBUG_CERTIFICATE $(CY_DBG_CERTIFICATE_PATH)" -c \
