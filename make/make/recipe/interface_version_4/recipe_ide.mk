...
ifneq ($(MTB_COMBINE_SIGN_$(_MTB_RECIPE__IDE_PRJ_DIR_NAME)_HEX_FILES),)
	$(call mtb__file_append,$(_MTB_RECIPE__IDE_TEXT_DATA_FILE),&&_PROGRAM_IMG_FOR_PGMGUI&&=$${cy_prj_path}/$(MTB_COMBINE_SIGN_$(_MTB_RECIPE__COMBINE_SIGN_IDX)_HEX_PATH))
else
	$(call mtb__file_append,$(_MTB_RECIPE__IDE_TEXT_DATA_FILE),&&_PROGRAM_IMG_FOR_PGMGUI&&=$(_MTB_RECIPE__ECLIPSE_PRJ_PROG_FILE))
endif
	$(call mtb__file_append,$(_MTB_RECIPE__IDE_TEXT_DATA_FILE),&&_MTB_RECIPE__QSPI_FLM_FOR_PGMGUI&&=$${cy_prj_path}/$(patsubst %/,%,$(CY_QSPI_FLM_DIR_OUTPUT))/PSE84_SMIF.FLM)
ifeq ($(_USER_DEFINED_CERT),true)
	...
	$(call mtb__file_append,$(_MTB_RECIPE__IDE_TEXT_DATA_FILE),&&_MTB_RECIPE__DBG_CERT_PATH_ABS&&=$${cy_prj_path}/$(CY_DBG_CERTIFICATE_PATH))
endif
...
recipe_eclipse_combine_sign_meta:
	...
	$(call mtb__file_append,$(_MTB_RECIPE__ECLIPSE_COMBINE_SIGN_META_DATA_FILE),TEMPLATE_REPLACE=$(MTB_TOOLS__RECIPE_DIR)/make/recipe/$(_MTB_RECIPE__IDE_EXPORT_INTERFACE_VERSION)/Proj/combine_sign/Program.launch=$(_MTB_RECIPE__ECLIPSE_CS_DST_BASE_NAME) Program $(_MTB_RECIPE__PROGRAM_INTERFACE_LAUNCH_SUFFIX).launch)
	...
	$(call mtb__file_append,$(_MTB_RECIPE__ECLIPSE_COMBINE_SIGN_META_DATA_FILE),TEMPLATE_REPEAT=$(_MTB_RECIPE__ECLIPSE_CS_DST_BASE_NAME) Program $(_MTB_RECIPE__PROGRAM_INTERFACE_LAUNCH_SUFFIX).launch=$(MTB_COMBINE_SIGN_$(_MTB_RECIPE__IDE_PRJ_DIR_NAME)_HEX_FILES))
